...
from environments.rewards import reward_1, default_reward_fcn, distance_energy_reward, distance_reward_fcn, reward_pendulum_dist
from ray.rllib.models import ModelCatalog
from custom_logging import MyCallbacks, custom_logger_creator
from environments.ObservationWrappers import LocalFrameRPYEnv, GlobalFrameRPYEnv, LocalFrameRPYParamsEnv
...
model = RMA_model  # custom model to use
dist = MyBetaDist
experiment_logdir = 'RMA'  # name of the directory in ~/ray_results to log to
...
eval_env_config['reward_fcn'] = distance_reward_fcn
eval_env_config['max_steps'] = 2048
eval_env_config['difficulty'] = 0.1
